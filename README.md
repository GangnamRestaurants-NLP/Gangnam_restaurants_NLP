...
------------
## 🥂 목표
- 본 프로젝트의 목표는 머신러닝을 이용하여 강남역 회식 장소 리뷰를 수집, 이를 자연어 처리하여 도움 되는 리뷰를 분류하였습니다. 
- 머신러닝을 이용한 강남역 회식장소 리뷰 중 도움이 되는 리뷰 분류 프로젝트
- 머신러닝을 이용한 강남역 회식장소 선정에 도움이 되는 리뷰 분류 프로젝트
- 강남역 회식장소 선정에 도움이 되는 리뷰 분류 프로젝트(with 머신러닝)
